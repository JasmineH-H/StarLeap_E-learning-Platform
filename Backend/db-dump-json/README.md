...
You can set `MONGO_URI` and `MONGO_DB` environment variables to control the target database. By default the scripts use `mongodb://localhost:27017` and database `starleap`.
